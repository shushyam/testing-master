...
namespace HoloToolkit.Examples.InteractiveElements
{
    ...
    public class Interactive : MonoBehaviour, IInputClickHandler, IFocusable, IInputHandler
    {
      ...
      switch (this.gameObject.name)
      {
        ...
        case ("demo2"):
          SceneManager.LoadSceneAsync("testing/Scenes/NanoCarbon", LoadSceneMode.Single);
          break;
        case ("demo1"):
          SceneManager.LoadSceneAsync("testing/Scenes/RDX", LoadSceneMode.Single);
          break;
        case ("demo3"):
          SceneManager.LoadSceneAsync("testing/Scenes/mos2-scene1", LoadSceneMode.Single);
          break;
        case ("demo4"):
          SceneManager.LoadSceneAsync("testing/Scenes/Demo4(LJ)", LoadSceneMode.Single);
          break;
        ...
        case ("BackBtn"):
          ...
          break;
        case ("Next"):
          SceneManager.LoadSceneAsync("testing/Scenes/mos2-scene2", LoadSceneMode.Single);
          break;
         case ("Prev"):
           SceneManager.LoadSceneAsync("testing/Scenes/mos2-scene1", LoadSceneMode.Single);
           break;
